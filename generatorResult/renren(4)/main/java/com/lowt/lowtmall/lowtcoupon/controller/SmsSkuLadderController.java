...
import com.lowt.lowtmall.lowtcoupon.service.SmsSkuLadderService;
 ...
 */
@RestController
@RequestMapping("lowtcoupon/smsskuladder")
public class SmsSkuLadderController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smsskuladder:list")
    ...
    //@RequiresPermissions("lowtcoupon:smsskuladder:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smsskuladder:save")
    ...
    //@RequiresPermissions("lowtcoupon:smsskuladder:update")
    ...
    //@RequiresPermissions("lowtcoupon:smsskuladder:delete")
