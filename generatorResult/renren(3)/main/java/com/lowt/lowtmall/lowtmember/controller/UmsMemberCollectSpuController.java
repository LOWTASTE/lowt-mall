...
import com.lowt.lowtmall.lowtmember.service.UmsMemberCollectSpuService;
 ...
 */
@RestController
@RequestMapping("lowtmember/umsmembercollectspu")
public class UmsMemberCollectSpuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtmember:umsmembercollectspu:list")
    ...
    //@RequiresPermissions("lowtmember:umsmembercollectspu:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtmember:umsmembercollectspu:save")
    ...
    //@RequiresPermissions("lowtmember:umsmembercollectspu:update")
    ...
    //@RequiresPermissions("lowtmember:umsmembercollectspu:delete")
