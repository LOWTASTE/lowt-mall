 ...
 */
@RestController
@RequestMapping("lowtcoupon/smscouponspucategoryrelation")
public class SmsCouponSpuCategoryRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smscouponspucategoryrelation:list")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponspucategoryrelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smscouponspucategoryrelation:save")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponspucategoryrelation:update")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponspucategoryrelation:delete")
