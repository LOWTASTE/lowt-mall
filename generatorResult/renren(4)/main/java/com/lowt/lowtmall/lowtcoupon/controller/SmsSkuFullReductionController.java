...
import com.lowt.lowtmall.lowtcoupon.service.SmsSkuFullReductionService;
 ...
 */
@RestController
@RequestMapping("lowtcoupon/smsskufullreduction")
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smsskufullreduction:list")
    ...
    //@RequiresPermissions("lowtcoupon:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smsskufullreduction:save")
    ...
    //@RequiresPermissions("lowtcoupon:smsskufullreduction:update")
    ...
    //@RequiresPermissions("lowtcoupon:smsskufullreduction:delete")
