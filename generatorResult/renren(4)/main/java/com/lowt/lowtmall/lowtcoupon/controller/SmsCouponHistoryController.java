...
import com.lowt.lowtmall.lowtcoupon.service.SmsCouponHistoryService;
 ...
 */
@RestController
@RequestMapping("lowtcoupon/smscouponhistory")
public class SmsCouponHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smscouponhistory:list")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponhistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smscouponhistory:save")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponhistory:update")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponhistory:delete")
