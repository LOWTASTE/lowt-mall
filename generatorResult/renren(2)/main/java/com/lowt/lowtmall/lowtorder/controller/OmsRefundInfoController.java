...
import com.lowt.lowtmall.lowtorder.service.OmsRefundInfoService;
 ...
 */
@RestController
@RequestMapping("lowtorder/omsrefundinfo")
public class OmsRefundInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtorder:omsrefundinfo:list")
    ...
    //@RequiresPermissions("lowtorder:omsrefundinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtorder:omsrefundinfo:save")
    ...
    //@RequiresPermissions("lowtorder:omsrefundinfo:update")
    ...
    //@RequiresPermissions("lowtorder:omsrefundinfo:delete")
