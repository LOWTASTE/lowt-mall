 ...
 */
@RestController
@RequestMapping("lowtorder/omspaymentinfo")
public class OmsPaymentInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtorder:omspaymentinfo:list")
    ...
    //@RequiresPermissions("lowtorder:omspaymentinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtorder:omspaymentinfo:save")
    ...
    //@RequiresPermissions("lowtorder:omspaymentinfo:update")
    ...
    //@RequiresPermissions("lowtorder:omspaymentinfo:delete")
