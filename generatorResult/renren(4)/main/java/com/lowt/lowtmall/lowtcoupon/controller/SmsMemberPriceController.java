...
import com.lowt.lowtmall.lowtcoupon.service.SmsMemberPriceService;
 ...
 */
@RestController
@RequestMapping("lowtcoupon/smsmemberprice")
public class SmsMemberPriceController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smsmemberprice:list")
    ...
    //@RequiresPermissions("lowtcoupon:smsmemberprice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smsmemberprice:save")
    ...
    //@RequiresPermissions("lowtcoupon:smsmemberprice:update")
    ...
    //@RequiresPermissions("lowtcoupon:smsmemberprice:delete")
