...
import com.lowt.lowtmall.lowtcoupon.service.SmsCouponSpuRelationService;
 ...
 */
@RestController
@RequestMapping("lowtcoupon/smscouponspurelation")
public class SmsCouponSpuRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smscouponspurelation:list")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponspurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smscouponspurelation:save")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponspurelation:update")
    ...
    //@RequiresPermissions("lowtcoupon:smscouponspurelation:delete")
