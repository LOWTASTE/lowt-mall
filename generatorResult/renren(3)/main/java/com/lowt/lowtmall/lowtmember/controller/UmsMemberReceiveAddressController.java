...
import com.lowt.lowtmall.lowtmember.service.UmsMemberReceiveAddressService;
 ...
 */
@RestController
@RequestMapping("lowtmember/umsmemberreceiveaddress")
public class UmsMemberReceiveAddressController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtmember:umsmemberreceiveaddress:list")
    ...
    //@RequiresPermissions("lowtmember:umsmemberreceiveaddress:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtmember:umsmemberreceiveaddress:save")
    ...
    //@RequiresPermissions("lowtmember:umsmemberreceiveaddress:update")
    ...
    //@RequiresPermissions("lowtmember:umsmemberreceiveaddress:delete")
