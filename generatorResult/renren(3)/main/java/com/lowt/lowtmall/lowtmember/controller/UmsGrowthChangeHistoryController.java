 ...
 */
@RestController
@RequestMapping("lowtmember/umsgrowthchangehistory")
public class UmsGrowthChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtmember:umsgrowthchangehistory:list")
    ...
    //@RequiresPermissions("lowtmember:umsgrowthchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtmember:umsgrowthchangehistory:save")
    ...
    //@RequiresPermissions("lowtmember:umsgrowthchangehistory:update")
    ...
    //@RequiresPermissions("lowtmember:umsgrowthchangehistory:delete")
