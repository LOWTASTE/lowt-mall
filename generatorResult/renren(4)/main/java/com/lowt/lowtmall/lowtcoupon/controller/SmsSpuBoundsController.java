 ...
 */
@RestController
@RequestMapping("lowtcoupon/smsspubounds")
public class SmsSpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtcoupon:smsspubounds:list")
    ...
    //@RequiresPermissions("lowtcoupon:smsspubounds:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtcoupon:smsspubounds:save")
    ...
    //@RequiresPermissions("lowtcoupon:smsspubounds:update")
    ...
    //@RequiresPermissions("lowtcoupon:smsspubounds:delete")
