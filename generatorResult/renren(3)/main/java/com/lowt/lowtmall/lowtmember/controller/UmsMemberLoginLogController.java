 ...
 */
@RestController
@RequestMapping("lowtmember/umsmemberloginlog")
public class UmsMemberLoginLogController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtmember:umsmemberloginlog:list")
    ...
    //@RequiresPermissions("lowtmember:umsmemberloginlog:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtmember:umsmemberloginlog:save")
    ...
    //@RequiresPermissions("lowtmember:umsmemberloginlog:update")
    ...
    //@RequiresPermissions("lowtmember:umsmemberloginlog:delete")
