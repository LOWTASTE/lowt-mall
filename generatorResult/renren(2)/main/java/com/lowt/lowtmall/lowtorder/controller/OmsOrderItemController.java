 ...
 */
@RestController
@RequestMapping("lowtorder/omsorderitem")
public class OmsOrderItemController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtorder:omsorderitem:list")
    ...
    //@RequiresPermissions("lowtorder:omsorderitem:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtorder:omsorderitem:save")
    ...
    //@RequiresPermissions("lowtorder:omsorderitem:update")
    ...
    //@RequiresPermissions("lowtorder:omsorderitem:delete")
