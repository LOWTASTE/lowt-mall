...
import com.lowt.lowtmall.lowtorder.service.OmsOrderOperateHistoryService;
 ...
 */
@RestController
@RequestMapping("lowtorder/omsorderoperatehistory")
public class OmsOrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("lowtorder:omsorderoperatehistory:list")
    ...
    //@RequiresPermissions("lowtorder:omsorderoperatehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lowtorder:omsorderoperatehistory:save")
    ...
    //@RequiresPermissions("lowtorder:omsorderoperatehistory:update")
    ...
    //@RequiresPermissions("lowtorder:omsorderoperatehistory:delete")
